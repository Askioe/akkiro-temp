...
void UI::Render()
{
    ...
    ::RegisterClassEx(&wc);
    const HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("Akkiro"), WS_OVERLAPPEDWINDOW, 100, 100, 50, 50, NULL, NULL, wc.hInstance, NULL);
    ...
    io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\Corbel.ttf", 18.5f, NULL, io.Fonts->GetGlyphRangesJapanese());
